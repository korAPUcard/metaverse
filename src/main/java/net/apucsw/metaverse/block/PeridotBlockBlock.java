...
public class PeridotBlockBlock extends MetaverseModElements.ModElement {
	@ObjectHolder("metaverse:peridot_block")
	public static final Block block = null;

	public PeridotBlockBlock(MetaverseModElements instance) {
		super(instance, 13);
	}
